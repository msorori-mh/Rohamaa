...
class AdminStats {
  ...
  final int donations; final int needs; final int deliveries; final int pendingContributions; final int openRiskFlags;
}
...
class AdminRepository {
  ...
  Future<AdminStats> stats() async {
    ...
    return AdminStats(donations:(donations as List).length,needs:(needs as List).length,deliveries:(deliveries as List).length,pendingContributions:(contributions as List).length,openRiskFlags:(risks as List).length);
  }
