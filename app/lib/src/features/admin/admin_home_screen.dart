...
class _AdminHomeScreenState extends State<AdminHomeScreen> {
  ...
  void _reload() {
    _future = AdminRepository(Supabase.instance.client).stats();
  }
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                _Action(icon: Icons.manage_accounts_outlined, title: 'المستخدمون والمندوبون', subtitle: 'إدارة الأدوار وتجميد الحسابات عند الضرورة.', onTap: () => _open(const UserManagementScreen())),
              ],
            ),
          );
        },
