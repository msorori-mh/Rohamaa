...
const ruhamaaIntroSeenKey = 'ruhamaa_intro_seen_v1';
...
class _IntroScreenState extends State<IntroScreen> {
  ...
  static const _pages = <_IntroPageData>[
    _IntroPageData(
      ...
      body: 'منصة مجتمعية توصل الأشياء التي لم تعد تحتاجها إلى أشخاص سجلوا احتياجهم مسبقًا، بخصوصية وكرامة.',
      accent: RuhamaaColors.primary,
      footer: 'ما لديك قد يصنع فرقًا.',
    ),
    _IntroPageData(
      icon: Icons.route_rounded,
      title: 'كيف يعمل رحماء؟',
      body: 'أنت لا تبحث عن أشخاص ولا تتصفح تبرعات. رحماء يتولى المطابقة والتنسيق بين الأطراف.',
      accent: RuhamaaColors.warmGold,
      steps: [
        ('1', 'أضف شيئًا أو سجّل احتياجك'),
        ('2', 'يراجع رحماء التطابق المناسب'),
        ('3', 'يتولى موصل رحماء الاستلام والتوصيل'),
      ],
    ),
    _IntroPageData(
      icon: Icons.shield_rounded,
      title: 'الخصوصية أولًا',
      body: 'لا يعرف المتبرع هوية المستفيد، ولا يعرف المستفيد هوية المتبرع. ويطّلع فريق التشغيل والموصل فقط على أقل قدر من البيانات اللازمة لتنفيذ المهمة.',
      accent: RuhamaaColors.primaryDark,
      footer: 'موقعك وبيانات تواصلك لا تظهر للطرف الآخر.',
    ),
    _IntroPageData(
