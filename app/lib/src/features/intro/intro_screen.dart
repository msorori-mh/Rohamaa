...
class _IntroScreenState extends State<IntroScreen> {
  ...
  static const _pages = <_IntroPageData>[
    _IntroPageData(
      ...
      title: 'مرحبًا بك في عطاء',
      body: 'منصة مجتمعية تربط الأشياء والوقت والمهارات غير المستغلة باحتياجات حقيقية، بخصوصية وكرامة. قد تحتاج شيئًا اليوم، وفي الوقت نفسه يكون لديك شيء أو مهارة تستطيع تقديمها.',
      accent: RuhamaaColors.primary,
      footer: 'ما لديك — شيء أو وقت أو مهارة — قد يصنع فرقًا.',
    ),
    _IntroPageData(
      icon: Icons.route_rounded,
      title: 'كيف يعمل عطاء؟',
      body: 'لا توجد هوية ثابتة باسم «متبرع» أو «محتاج»، ولا تتصفح الناس أو عروضهم. سجّل ما تحتاجه أو ما تستطيع تقديمه، وعطاء يتولى المراجعة والمطابقة.',
      accent: RuhamaaColors.warmGold,
      steps: [
        ('1', 'أضف شيئًا، قدّم وقتك أو مهارتك، أو سجّل احتياجك'),
        ('2', 'يراجع عطاء الاحتياج والعطاء ويبحث عن التطابق المناسب'),
        ('3', 'للأشياء ننسّق الاستلام والتوصيل، وللخدمات ننسّق الموعد والحد الأدنى من المعلومات'),
      ],
    ),
    _IntroPageData(
      icon: Icons.shield_rounded,
      title: 'الخصوصية أولًا',
      body: 'في تبرعات الأشياء لا يعرف المتبرع هوية المستفيد ولا المستفيد هوية المتبرع. أما الخدمة الحضورية كسباكة أو كهرباء، فلا يحصل مقدم الخدمة على معلومات الشخص أو الموقع إلا بعد اعتماد المطابقة، وبالقدر الضروري لتنفيذ الموعد فقط.',
      accent: RuhamaaColors.primaryDark,
      footer: 'لا يرى مقدم الخدمة سجل احتياجاتك الأخرى، ولا يُعرض طلبك أو عرض مهارتك للعامة.',
    ),
    _IntroPageData(
      icon: Icons.local_shipping_rounded,
      title: 'المساهمة في التوصيل اختيارية',
      body: 'إن استطعت، يمكنك المساهمة في تكلفة استلام عطائك أو توصيل احتياجك. ومساهمات القادرين تساعد عطاء أيضًا على خدمة أشخاص لا يستطيعون تحمل تكلفة التوصيل.',
      accent: RuhamaaColors.warmGold,
      contribution: true,
      footer: 'لا يوجد دفع داخل التطبيق. المبلغ يُسلّم نقدًا لموصل عطاء، وعدم المساهمة لا يمنع الخدمة ولا يقلل أولوية الاستحقاق. وتقديم الوقت أو المهارة لا يمنح أولوية إضافية أيضًا.',
    ),
  ];
