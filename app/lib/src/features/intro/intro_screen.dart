...
class _IntroScreenState extends State<IntroScreen> {
  ...
  static const _pages = <_IntroPageData>[
    ...
    _IntroPageData(
      ...
      body: 'لا توجد هوية ثابتة باسم «متبرع» أو «محتاج»، ولا تتصفح الناس أو عروضهم. سجّل ما تحتاجه أو ما تستطيع تقديمه، ورحماء يتولى المراجعة والمطابقة.',
      accent: RuhamaaColors.warmGold,
      steps: [
        ('1', 'أضف شيئًا، قدّم وقتك أو مهارتك، أو سجّل احتياجك'),
        ('2', 'يراجع رحماء الاحتياج والعطاء ويبحث عن التطابق المناسب'),
    ...
    _IntroPageData(
      ...
      accent: RuhamaaColors.warmGold,
      contribution: true,
      footer: 'لا يوجد دفع داخل التطبيق. المبلغ يُسلّم نقدًا لموصل رحماء، وعدم المساهمة لا يمنع الخدمة ولا يقلل أولوية الاستحقاق. وتقديم الوقت أو المهارة لا يمنح أولوية إضافية أيضًا.',
    ),
  ];
