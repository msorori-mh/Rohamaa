    ...
    try {
      ...
      final contribute = await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text(
            'تبرعك بالشيء هو الأهم وقد يصنع فرقًا حقيقيًا. وإذا استطعت، يمكنك أيضًا المساهمة في تكلفة استلامه وتوصيله؛ ومساهمتك تساعد عطاء على إيصال تبرعات أخرى لأشخاص لا يستطيعون تحمل تكلفة التوصيل. لا يوجد دفع داخل التطبيق، والمبلغ يُسلَّم نقدًا للموصل عند الاستلام.',
          ),
          actions: [
            TextButton(
              ...
              Container(
                ...
                child: const Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'هذه الحاجة ألهمت عطائك، لذلك ملأنا بعض البيانات لك. لا يعني ذلك أن الشيء محجوز لنفس الحالة؛ عطاء يوجّه العطاء للحاجة الأعلى أولوية من الحالات المتوافقة.',
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                child: Text(
                  _inspired
                      ? 'بعد الإرسال يراجع عطاء العطاء ويطابقه بعدل. البطاقة التي رأيتها تحفّز العطاء فقط ولا تمنح صاحبها حقًا حصريًا في هذا الشيء.'
                      : 'بعد الإرسال يراجع عطاء العطاء ويبحث عن احتياج مناسب. لا يختار المتبرع المستفيد ولا تظهر هوية أي طرف للآخر.',
