...
- الاحتياج والعطاء مستقلان تمامًا.
...
- البطاقة التي ألهمت العطاء لا تضمن أن الشيء سيذهب لصاحبها؛ المطابقة النهائية تبقى حسب الأولوية والملاءمة.
- بحد أقصى بطاقتان معروضتان لكل حساب في الوقت نفسه.
- عند إرسال عرض مطابقة خاص للمستفيد تختفي البطاقة من شاشة التحفيز.
- كثافة الطلبات غير المعتادة ترفع إشارة مراجعة بشرية، ولا تُنقص الاستحقاق تلقائيًا.

## Examples

- سباك يحتاج أثاثًا ويمكنه تقديم 3 ساعات سباكة.
- كهربائي يحتاج ملابس أطفال ويمكنه تقديم نصف يوم كهرباء منزلية.
- خياط يحتاج جهازًا ويمكنه تقديم تعديلات ملابس.
- محل كوافير يقدّم تجهيز عروس مجانًا.
- محل كوش يقدّم كوشة بسيطة مجانًا في أوقات محددة.
- ورشة تصلح جهازًا متبرعًا به قبل توصيله لمستفيد.

## V1 service economics

Allowed:
- Free service.
- Free labor where materials/parts are supplied separately according to the reviewed case.

Not allowed in V1:
- Open commercial pricing.
- Bidding or negotiation.
- Marketplace listings.
- Reciprocal-service requirements.
...
- only operational information needed for the scheduled service.
...
- Moving/light assembly
- Beauty/wedding preparation
- Event setup/decor
- Printing/stationery
- Other reviewed skill

## Safety rule

Services with higher safeguarding, medical, regulated, or child-care risk remain outside the initial service pilot until separate controls are designed and approved.
